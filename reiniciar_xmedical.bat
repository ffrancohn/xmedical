...
echo ========================================
echo XMedical - Reinicio del sistema
echo ========================================
echo.

echo Deteniendo Django si estaba en ejecucion...
taskkill /FI "WINDOWTITLE eq XMedical Django*" /F >nul 2>&1
...
echo.
echo Servicios Docker reiniciados. Los datos se conservan.
